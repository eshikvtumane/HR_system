...
urlpatterns = patterns('',
    ...
    url(r'^get_vacancy_status_distribution/$','reports.views.get_vacancy_status_distribution'),
    url(r'^get_vacancies_to_applicants_rate/$','reports.views.get_vacancies_to_applicants_rate')
