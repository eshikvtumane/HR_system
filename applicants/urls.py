...
from views import ApplicantAddView, CandidateSearchView, VacancySearchAjax, \
    ApplicantView, ApplicantVacancyStatusAjax,ApplicantAppointmentView
...
urlpatterns = patterns('',
    ...
    url(r'^view/(?P<applicant_id>[0-9]+)/$', ApplicantView.as_view(), name='applicant_view'),
     url(r'^view/(?P<applicant_id>[0-9]+)/appointment/$',
         ApplicantAppointmentView.as_view(), name='applicant_appointment'),
